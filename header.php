...
<body>
    <nav class="navbar navbar-expand-lg bg-dark text-center ">
        <div class="container-fluid text-bg-light ">
            <a class="navbar-brand m-0 h1" href="index.php">GERADOR PROVAS</a>
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <a class="nav-link m-0 h1" href="perguntas.php">CADASTRE NOVA QUESTÃO</a>
                    <a class="nav-link m-0 h1" href="prova.php">RESPONDA A PROVA</a>
                </div>
            </div>
        </div>
    </nav>